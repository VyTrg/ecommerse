...
INSERT [dbo].[order] ([id], [orderDate], [order_total], [user_id], [shipping_address_id], [shipping_method_id], [order_status_id], [guest_name], [guest_email], [guest_phone]) VALUES (25, CAST(N'2025-05-28T03:51:41.1300000' AS DateTime2), CAST(250.00 AS Decimal(10, 2)), NULL, 1, 1, 1, N'Nguyễn Văn A', N'a@gmail.com', N'0912345678')
INSERT [dbo].[order] ([id], [orderDate], [order_total], [user_id], [shipping_address_id], [shipping_method_id], [order_status_id], [guest_name], [guest_email], [guest_phone]) VALUES (26, CAST(N'2025-05-28T03:54:51.2800000' AS DateTime2), CAST(105.00 AS Decimal(10, 2)), NULL, 4, 1, 1, N'aaaa', N'aaaa', N'3432432432')
INSERT [dbo].[order] ([id], [orderDate], [order_total], [user_id], [shipping_address_id], [shipping_method_id], [order_status_id], [guest_name], [guest_email], [guest_phone]) VALUES (27, CAST(N'2025-05-30T11:37:01.3133333' AS DateTime2), CAST(200.00 AS Decimal(10, 2)), NULL, 5, 1, 1, N'huy ', N'huyjuan2004@gmail.com', N'13213213')
INSERT [dbo].[order] ([id], [orderDate], [order_total], [user_id], [shipping_address_id], [shipping_method_id], [order_status_id], [guest_name], [guest_email], [guest_phone]) VALUES (28, CAST(N'2025-05-30T13:15:57.3266667' AS DateTime2), CAST(750.00 AS Decimal(10, 2)), NULL, 6, 1, 1, N'nhat huy', N'huyjuan2004@gmail.com', N'094560001')
INSERT [dbo].[order] ([id], [orderDate], [order_total], [user_id], [shipping_address_id], [shipping_method_id], [order_status_id], [guest_name], [guest_email], [guest_phone]) VALUES (29, CAST(N'2025-06-12T10:25:46.6900000' AS DateTime2), CAST(200.00 AS Decimal(10, 2)), NULL, 7, 1, 1, N'abcd', N'huyjuan2004@gmail.com', N'01939238')
INSERT [dbo].[order] ([id], [orderDate], [order_total], [user_id], [shipping_address_id], [shipping_method_id], [order_status_id], [guest_name], [guest_email], [guest_phone]) VALUES (30, CAST(N'2025-06-12T10:35:37.2033333' AS DateTime2), CAST(335.00 AS Decimal(10, 2)), NULL, 8, 1, 1, N'sssaaa', N'huyjuan2004@gmail.com', N'094657811')
INSERT [dbo].[order] ([id], [orderDate], [order_total], [user_id], [shipping_address_id], [shipping_method_id], [order_status_id], [guest_name], [guest_email], [guest_phone]) VALUES (31, CAST(N'2025-06-12T10:35:50.7100000' AS DateTime2), CAST(335.00 AS Decimal(10, 2)), NULL, 9, 1, 1, N'sssaaa', N'huyjuan2004@gmail.com', N'094657811')
INSERT [dbo].[order] ([id], [orderDate], [order_total], [user_id], [shipping_address_id], [shipping_method_id], [order_status_id], [guest_name], [guest_email], [guest_phone]) VALUES (32, CAST(N'2025-06-12T10:43:20.3633333' AS DateTime2), CAST(335.00 AS Decimal(10, 2)), NULL, 10, 1, 1, N'ddddd', N'huyjuan2004@gmail.com', N'019328311')
INSERT [dbo].[order] ([id], [orderDate], [order_total], [user_id], [shipping_address_id], [shipping_method_id], [order_status_id], [guest_name], [guest_email], [guest_phone]) VALUES (33, CAST(N'2025-06-12T10:47:22.9333333' AS DateTime2), CAST(335.00 AS Decimal(10, 2)), NULL, 11, 1, 1, N'ddddd', N'huyjuan2004@gmail.com', N'019328311')
INSERT [dbo].[order] ([id], [orderDate], [order_total], [user_id], [shipping_address_id], [shipping_method_id], [order_status_id], [guest_name], [guest_email], [guest_phone]) VALUES (34, CAST(N'2025-06-12T10:49:14.6400000' AS DateTime2), CAST(335.00 AS Decimal(10, 2)), NULL, 12, 1, 1, N'ddddd', N'huyjuan2004@gmail.com', N'019328311')
INSERT [dbo].[order] ([id], [orderDate], [order_total], [user_id], [shipping_address_id], [shipping_method_id], [order_status_id], [guest_name], [guest_email], [guest_phone]) VALUES (35, CAST(N'2025-06-12T10:52:26.5933333' AS DateTime2), CAST(335.00 AS Decimal(10, 2)), NULL, 13, 1, 1, N'ddddd', N'huyjuan2004@gmail.com', N'019328311')
...
INSERT [dbo].[order_status] ([id], [status]) VALUES (1, N'Chờ xác nhận')
INSERT [dbo].[order_status] ([id], [status]) VALUES (2, N'Đang giao')
INSERT [dbo].[order_status] ([id], [status]) VALUES (3, N'Hoàn tất')
INSERT [dbo].[order_status] ([id], [status]) VALUES (4, N'Đã huỷ')
